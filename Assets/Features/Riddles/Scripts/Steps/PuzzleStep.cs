...
{
    /// <summary>
    /// Шаг загадки (булев): завершён при совпадении значения с целевым
    /// </summary>
    [CreateAssetMenu(menuName = "Riddles/Steps/Step", fileName = nameof(PuzzleStep))]
    public sealed class PuzzleStep : BoolValue, IPuzzleStep
    {
        /// <inheritdoc/>
        ...
        {
            // Единый veto: группа недоступна / гейт закрыт / латч необратимости.
            // ResetState идёт мимо — через base.SetValue.
        ...
        {
            // Минуя veto и латч: прямой вызов базового SetValue — уведомляет подписчиков и сбрасывает сейв
